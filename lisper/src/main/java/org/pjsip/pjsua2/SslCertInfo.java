...
public class SslCertInfo {
  ...
  public void setSubjectAltName(SWIGTYPE_p_std__vectorT_pj__SslCertName_t value) {
    pjsua2JNI.SslCertInfo_subjectAltName_set(swigCPtr, this, SWIGTYPE_p_std__vectorT_pj__SslCertName_t.getCPtr(value));
  }

  public SWIGTYPE_p_std__vectorT_pj__SslCertName_t getSubjectAltName() {
    long cPtr = pjsua2JNI.SslCertInfo_subjectAltName_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_std__vectorT_pj__SslCertName_t(cPtr, false);
  }
